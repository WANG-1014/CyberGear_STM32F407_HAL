...
extern void set_position_cybergear(MI_Motor *Motor, float position, float max_speed, float limit_current , float kp);
extern void set_speed_cybergear(MI_Motor *Motor, float speed);
